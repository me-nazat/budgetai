        ...
        <div className="min-h-screen bg-gradient-to-br from-bg-light to-blue-50/50 dark:from-[#0B0F19] dark:to-[#111827] flex items-center justify-center p-4 relative overflow-hidden">
            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="text-center mb-8 animate-slide-up" style={{ animationDelay: '0.1s' }}>
                    ...
                    <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Wealth AI</h1>
                    <p className="text-gray-500 dark:text-text-muted mt-2">Sign in to manage your finances</p>
                </div>
                ...
                <div className="card-premium rounded-2xl p-8 sm:p-10 shadow-xl animate-slide-up" style={{ animationDelay: '0.2s' }}>
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        >
                            {loading ? <div className="flex items-center justify-center gap-2"><div className="w-5 h-5 border-2 border-white border-t-transparent rounded-full animate-spin"></div> Signing in...</div> : 'Sign In'}
                        </button>
                    </form>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-sm text-gray-500 dark:text-text-muted">
                            ...
                            <a href="/register" onClick={(e) => { e.preventDefault(); router.push('/register'); }} className="text-primary font-medium hover:underline">
                                Create one
                            </a>
                        </p>
                    </div>
