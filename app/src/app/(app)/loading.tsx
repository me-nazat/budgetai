    ...
    return (
        <div className="p-4 lg:p-8 max-w-[1600px] mx-auto min-h-[60vh] flex flex-col">
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4 mb-8 stagger-children">
                {[0, 1, 2, 3].map(item => (
                    <div key={item} className="p-6 rounded-3xl border border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-surface-dark/50 shadow-sm card-premium-v2 breathe">
            ...
            <div className="grid grid-cols-1 gap-5 lg:grid-cols-3 flex-1 stagger-children">
                <div className="lg:col-span-2 rounded-3xl border border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-surface-dark/50 p-6 min-h-[360px] shimmer-skeleton card-premium-v2 breathe" style={{ animationDelay: '100ms' }} />
                <div className="rounded-3xl border border-gray-100 dark:border-white/5 bg-gray-50/50 dark:bg-surface-dark/50 p-6 min-h-[360px] shimmer-skeleton card-premium-v2 breathe" style={{ animationDelay: '200ms' }} />
            </div>
        </div>
    );
}
