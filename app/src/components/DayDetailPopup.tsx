        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[70]" onClick={onClose}>
                ...
                <motion.div
                    ...
                    className="absolute w-[380px] max-h-[440px] flex flex-col bg-white dark:bg-[#161b22] rounded-2xl shadow-2xl border border-gray-200/70 dark:border-[#30363d] overflow-hidden"
