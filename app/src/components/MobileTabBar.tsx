...
export default function MobileTabBar() {
    ...
    return (
        <>
            <div
                className="lg:hidden fixed inset-x-3 z-50 rounded-[1.75rem] border border-white/70 bg-white/78 shadow-2xl shadow-slate-900/16 backdrop-blur-2xl transition-all duration-300 ease-out dark:border-white/5 dark:bg-[#0A0A0C]/80 dark:shadow-[0_8px_32px_rgba(0,0,0,0.8)]"
                            ...
                            >
                                {isActive && (
                                    <motion.div 
                                        ...
                                        className="absolute inset-x-2 top-2 bottom-2 rounded-2xl bg-primary/10 dark:bg-primary/15 border border-primary/20" 
                                        initial={false}
